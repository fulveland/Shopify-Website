...
(function() {
  var Ease, PureMath, SCROLL_ANIMATION_SPEED, animate, duration, endScroll, endTime, startScroll, startTime;

  angular.module("FehuApp", ["ngRoute", "ngTouch", "About", "Locations", "Shop", "Wholesale", "PageStyle", "Routes"]);
  ...
  angular.module("Shop", []).directive("scrollJack", function() {
    return {
